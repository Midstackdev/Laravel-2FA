...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Two factor auhtentication</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('authy.check') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (request()->session()->get('authy.using_sms'))
                                    <a class="btn btn-link" href="{{ route('authy.check.resend') }}">
                                        {{ __('Token not arrived? Resend token') }}
                                    </a>
                                @endif
                            </div>
                        </div>
